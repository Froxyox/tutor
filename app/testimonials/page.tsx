...
const testimonials = [
  {
    ...
    quote: 'I started with EliteSHSAT scoring a 420 on my first practice test. After 3 months with Jordan, I scored a 541 on the real thing — well above Brooklyn Tech\'s cutoff. Jordan broke down every math topic in a way that actually made sense. He\'d show me shortcuts I never would have found in any prep book.',
    subject: 'Math',
    improvement: '+121 pts',
  ...
  },
  {
    ...
    grade: 'Rising 9th Grader',
    quote: 'Priya\'s ELA approach completely changed how I read passages. I was always running out of time, but she taught me how to annotate strategically and scan for answers instead of re-reading everything. My ELA score went from a 195 to a 268 in 10 weeks. She\'s genuinely one of the best teachers I\'ve ever had.',
    subject: 'ELA',
  ...
  },
  {
    ...
    grade: 'Rising 9th Grader',
    quote: 'We tried two other tutors before EliteSHSAT and neither of them had the same level of detail. Jordan and Priya gave me a weekly plan, checked in constantly, and actually cared whether I was improving. My Stuy score was 578 — I never thought I\'d make it. This program is the real deal.',
    subject: 'Full Prep',
    improvement: '+145 pts',
    color: 'border-navy-600',
  },
  ...
  },
  {
    ...
    grade: 'Rising 9th Grader',
    quote: 'I was really strong in math but kept losing points to careless errors and running out of time. Jordan\'s pacing strategies were a game changer — I finished with 15 minutes to spare on test day and had time to check my work. That alone probably gained me 30 points.',
    subject: 'Math',
    improvement: '+62 pts',
    color: 'border-gold-500',
  },
