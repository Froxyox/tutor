...
const plans = [
  {
    ...
    features: [
      ...
      'Custom ELA workbook (Jonathan\'s)',
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                name: 'ELA Workbook',
                price: '$15',
                desc: 'Jonathan\'s hand-crafted ELA workbook with 200+ practice questions and answer explanations.',
              },
              {
                icon: '🔢',
                name: 'Math Problem Sets',
                price: '$15',
                desc: 'Guanshen\'s curated topic-specific math drills sorted by difficulty. Great for solo practice.',
              },
              {
                icon: '📞',
